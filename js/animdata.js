...
// Grid
// Contains base face image, generated grid and information of different axis 
function FaceGrid()
{
    this.axes = 
    {   x: new Axis(),
    ...
    Grid.prototype.load_face = function(src)
    {
    }

    Grid.prototype.generate_grid = function()
    {
    }
